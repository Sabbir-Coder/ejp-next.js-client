...
export default function Navbar() {
    ...
    const links = [
        ...
        { href: '/manage-product', label: 'Manage Product' },
    ];
    ...
    return (
        <div className="md:px-10 bg-[#cecece] sticky top-0 z-50 mx-auto navbar shadow-sm">
            ...
            <div className="navbar-end">
                <SignedOut>
                    <SignInButton>
                        <button className="text-xl w-32 cursor-pointer h-12 rounded bg-emerald-500 text-white relative overflow-hidden group z-10 hover:text-white duration-1000">
                    ...
                    <SignUpButton>
                        <button className="ml-4 relative cursor-pointer py-3 px-8 text-center font-barlow inline-flex justify-center text-base uppercase text-blue-700 rounded-lg border-solid transition-transform duration-300 ease-in-out group outline-offset-4 focus:outline-2 focus:outline-blue-700 focus:outline-offset-4 overflow-hidden">
                            ...
                            <span className="w-1/2 drop-shadow-3xl transition-all duration-300 block border-[#0011ff] absolute h-[20%] rounded-tl-lg border-l-2 border-t-2 top-0 left-0"></span>
                            <span className="w-1/2 drop-shadow-3xl transition-all duration-300 block border-[#0011ff] absolute group-hover:h-[90%] h-[60%] rounded-tr-lg border-r-2 border-t-2 top-0 right-0"></span>
                            <span className="w-1/2 drop-shadow-3xl transition-all duration-300 block border-[#0011ff] absolute h-[60%] group-hover:h-[90%] rounded-bl-lg border-l-2 border-b-2 left-0 bottom-0"></span>
                            <span className="w-1/2 drop-shadow-3xl transition-all duration-300 block border-[#0011ff] absolute h-[20%] rounded-br-lg border-r-2 border-b-2 right-0 bottom-0"></span>
                        </button>
                    </SignUpButton>
                </SignedOut>
                <SignedIn>
